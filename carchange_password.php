                    ...
                    <div id="login-box" class="col-md-6">
                        ...
                        <div id="login-form" class="form">
                            ...
                            <div class="form-group text-white">
                                <h5><label for="username">Current Passowrd:</label><br></h5>
                                <input type="text" name="password" id="password" class="form-control" placeholder="enter old Password">
                            </div>
                            ...
                            <div class="form-group text-white">
                            <center><button type="submit" id="changepass" class="col-md-3 btn btn-danger text-white">Save</button></center>
                            </div>
                        </div>
                    </div>
                </div>
		...
		$(document).ready(function() {
			$(document).on('click', '#changepass', function(){
				...
				if (flag == 0) {
					...
					$.ajax({
						url: "<?php echo site_url('/Car_login/changepassword') ?>",
						method: 'POST',
						data: 
                        {
